 ...
 */
@Embeddable
public class TerceiroInteressadoPK implements Serializable {
    ...
    public TerceiroInteressadoPK() {
    }

    public TerceiroInteressadoPK(BigInteger codEmpresa, String numProcesso, BigInteger codParteProcesso) {
    ...
    public boolean equals(Object object) {
        if (!(object instanceof TerceiroInteressadoPK)) {
            return false;
        }
        TerceiroInteressadoPK other = (TerceiroInteressadoPK) object;
    ...
    public String toString() {
        return "br.com.telefonica.processum.model.TerceiroInteressadoPK[ codEmpresa=" + codEmpresa + ", numProcesso=" + numProcesso + ", codParteProcesso=" + codParteProcesso + " ]";
    }
