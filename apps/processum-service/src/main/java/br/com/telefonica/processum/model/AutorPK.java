...
public class AutorPK implements Serializable {
    ...
    public AutorPK(BigInteger codEmpresa, String numProcesso, BigInteger codParteProcesso) {
    ...
    public String toString() {
        return "br.com.telefonica.processum.model.AutorPK[ codEmpresa=" + codEmpresa + ", numProcesso=" + numProcesso + ", codParteProcesso=" + codParteProcesso + " ]";
    }
